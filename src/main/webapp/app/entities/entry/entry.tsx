...
export class Entry extends React.Component<IEntryProps, IEntryState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="entry-heading">
          <Translate contentKey="myFirstBlogApp.entry.home.title">Entries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="myFirstBlogApp.entry.home.createLabel">Create new Entry</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('title')}>
                    <Translate contentKey="myFirstBlogApp.entry.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('content')}>
                    <Translate contentKey="myFirstBlogApp.entry.content">Content</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('date')}>
                    <Translate contentKey="myFirstBlogApp.entry.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="myFirstBlogApp.entry.blog">Blog</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
