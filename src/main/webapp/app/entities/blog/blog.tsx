...
export class Blog extends React.Component<IBlogProps> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="blog-heading">
          <Translate contentKey="myFirstBlogApp.blog.home.title">Blogs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="myFirstBlogApp.blog.home.createLabel">Create new Blog</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="myFirstBlogApp.blog.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="myFirstBlogApp.blog.handle">Handle</Translate>
                </th>
                <th>
                  <Translate contentKey="myFirstBlogApp.blog.user">User</Translate>
                </th>
                <th />
              </tr>
            </thead>
