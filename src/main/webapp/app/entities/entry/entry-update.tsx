    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="myFirstBlogApp.entry.home.createOrEditLabel">
              <Translate contentKey="myFirstBlogApp.entry.home.createOrEditLabel">Create or edit a Entry</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : entryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="titleLabel" for="title">
                    <Translate contentKey="myFirstBlogApp.entry.title">Title</Translate>
                  </Label>
                  <AvField
                    id="entry-title"
                    type="text"
                ...
                <AvGroup>
                  <Label id="contentLabel" for="content">
                    <Translate contentKey="myFirstBlogApp.entry.content">Content</Translate>
                  </Label>
                  <AvField
                    id="entry-content"
                    type="text"
                ...
                <AvGroup>
                  <Label id="dateLabel" for="date">
                    <Translate contentKey="myFirstBlogApp.entry.date">Date</Translate>
                  </Label>
                  <AvInput
                    id="entry-date"
                    type="datetime-local"
                ...
                <AvGroup>
                  <Label for="blog.name">
                    <Translate contentKey="myFirstBlogApp.entry.blog">Blog</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="tags">
                    <Translate contentKey="myFirstBlogApp.entry.tag">Tag</Translate>
                  </Label>
                  <AvInput
                    id="entry-tag"
                    type="select"
